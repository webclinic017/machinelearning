...
# thuật toán GD: Momentum ----------------
# tìm điểm global optimal của hàm mất mát
# khắc phục việc nghiệm của GD rơi vào một điểm local minimum không mong muốn

# cần tính lượng thay đổi ở thời điểm t để cập nhật vị trí mới cho nghiệm
# coi đại lượng này như vận tốc
# tính vận tốc sao cho nó mang cả grad và momentum (tức vận tốc trước đó)
